...
public class TranslateGoogleAPI {
    public static String translate(String langFrom, String langTo, String text) throws IOException {
        ...
        URL url = new URL("https://script.google.com/macros/s/" + APIKEY + "/exec?q=" + URLEncoder.encode(text, String.valueOf(StandardCharsets.UTF_8)) + "&target=" + langTo + "&source=" + langFrom);
